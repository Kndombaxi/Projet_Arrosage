...
export default function DataScreen() {
  ...
  const processSensorData = (data: any): SensorData => {
    try {
      ...
      if (data && (data.Humidité !== undefined || data.Débit !== undefined || data.capteur1 !== undefined || data.capteur2 !== undefined)) {
      ...
      if (data && data.données) {
        ...
        } else if ((deviceName === "Capteur de présence d'eau" || deviceName === "Capteu de présence d'eau 1" || deviceName === "Capteu de présence d'eau 2") && valeur) {
          newSensorData.capteur1 = parseFloat(valeur as string) || 0;
        } else if ((deviceName === "Capteur eau supérieur à 500L" || deviceName === "Capteur eau supérieur à 500L") && valeur) {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (wsData && (wsData.Humidité !== null || wsData.Débit !== null || wsData.capteur1 !== null || wsData.capteur2 !== null)) {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.dataContainer}>
        ...
        <View style={styles.dataRow}>
          ...
          <Text style={styles.dataValue}>{formatValue(sensorData?.Débit, "L")}</Text>
        </View>
        <View style={styles.dataRow}>
